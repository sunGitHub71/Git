...
static const char qt_meta_stringdata_PlayListItem[] = {
    "PlayListItem\0"
};
...
const QMetaObjectExtraData PlayListItem::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PlayListItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PlayListItem,
      qt_meta_data_PlayListItem, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PlayListItem::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PlayListItem))
        return static_cast<void*>(const_cast< PlayListItem*>(this));
