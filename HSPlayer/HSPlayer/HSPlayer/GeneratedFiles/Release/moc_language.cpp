...
static const char qt_meta_stringdata_Language[] = {
    "Language\0"
};
...
const QMetaObjectExtraData Language::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Language::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Language,
      qt_meta_data_Language, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Language::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Language))
