...
static const char qt_meta_stringdata_MainLayout[] = {
    "MainLayout\0\0curList\0curOpenList(QStringList)\0"
    "openFile()\0"
};
...
void MainLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->curOpenList((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
...
// SIGNAL 0
void MainLayout::curOpenList(QStringList _t1)
{
